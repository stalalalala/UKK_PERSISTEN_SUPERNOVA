    ...
    <div class="max-w-[1440px] mx-10 w-full">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4 md:p-8">
            ...
            <div class="text-center mb-6">
                <div
                    class="inline-block w-full border border-gray-100 rounded-2xl p-4 md:p-6 bg-white relative overflow-hidden">
                    <h2 class="text-gray-500 text-xs md:text-base font-medium mb-6">Tiga Rekomendasi Jurusan Sesuai
                        Minat & Bakatmu</h2>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                        <div
                            class="bg-cyan-50 text-cyan-700 font-bold py-4 md:py-7 px-4 rounded-xl text-base md:text-xl border border-cyan-100 shadow-sm flex items-center justify-center">
                            Investigative
                        </div>
                        <div
                            class="bg-purple-50 text-purple-700 font-bold py-4 md:py-7 px-4 rounded-xl text-base md:text-xl border border-purple-100 shadow-sm flex items-center justify-center">
                            Artistic
                        </div>
                        <div
                            class="bg-orange-50 text-orange-700 font-bold py-4 md:py-7 px-4 rounded-xl text-base md:text-xl border border-orange-100 shadow-sm flex items-center justify-center">
                            Enterprising
                        </div>
                    </div>

                    <div
                        class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-400 via-purple-400 to-orange-400">
                    </div>
                </div>
            </div>
