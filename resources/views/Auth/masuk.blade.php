...
<head>
    ...
    <style>
        ...
        .slime-auto-left {
            ...
            animation: slime-breathe-soft 3s ease-in-out infinite, slime-auto-only-left 7s ease-in-out infinite;
        }
...
<body class="font-poppins bg-white min-h-screen flex flex-col relative">
    ...
    <div
        class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-auto lg:right-[-15vw] lg:translate-x-0 h-[90vh] md:h-[110vh] lg:h-[130vh] aspect-square bg-[#4A69BD] rounded-full z-0 flex items-center justify-center lg:justify-start opacity-90 lg:opacity-100 transition-all duration-700 ease-in-out">
        <div class="slime-auto-left w-[300px] md:w-[450px] lg:w-[550px] lg:ml-10 mb-10 relative z-10">
            <object data="{{ asset('img/pet(tanpa_animasi).svg') }}" type="image/svg+xml"
                class="pointer-events-none select-none w-full h-auto slime-shadow"></object>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto w-full px-4 md:px-10">
            <div class="grid lg:grid-cols-12 gap-4 items-center">
                ...
                <div class="lg:col-span-6 xl:col-span-5 flex justify-center lg:justify-start">
                    <div
                        class="bg-white/10 lg:bg-[#E8F1FF]/90 backdrop-blur-[4px] lg:backdrop-blur-xl w-full max-w-[450px] md:max-w-[480px] rounded-[40px] md:rounded-[50px] p-8 md:p-12 shadow-2xl border-4 border-white/40 lg:border-white/60 transition-all">
                        ...
                        <div class="flex justify-between items-center mb-8 gap-4">
                            ...
                            <a href="{{ route('login.google') }}"
                                class="flex items-center gap-2 bg-white px-3 py-2 rounded-xl shadow-sm hover:scale-105 transition-transform">
                                <span class="hidden md:block text-[10px] font-bold text-gray-400 uppercase">Masuk
                                    dengan</span>
                                <img src="https://www.gstatic.com/images/branding/product/1x/googleg_48dp.png"
                                    alt="Google" class="w-5 h-5 md:w-6 md:h-6">
                            </a>
                        </div>
