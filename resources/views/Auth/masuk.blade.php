...
<body class="font-poppins bg-white min-h-screen flex flex-col relative">
    ...
    <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
        ...
        <div class="slime-auto-left w-[300px] md:w-[450px] lg:w-[550px] 
    ...
    <nav class="relative z-30 w-full pt-6 px-4">
        <div class="max-w-6xl mx-auto flex items-center bg-[#F3F4F6]/80 backdrop-blur-md rounded-full shadow-sm border border-white p-2">
            <div class="w-24 md:w-28 h-8 md:h-9 bg-[#4A9FFF] rounded-full ml-2"></div>
            <div class="flex-grow"></div>
            <div class="w-16 md:w-20 h-8 md:h-9 bg-[#FFB81C] rounded-full mr-2"></div>
        </div>
    </nav>
        ...
        <div class="container mx-auto px-4 md:px-10">
            <div class="grid lg:grid-cols-12 gap-4 items-center">
                ...
                <div class="lg:col-span-6 xl:col-span-5 flex justify-center lg:justify-start">
                    <div class="bg-white/10 lg:bg-[#E8F1FF]/90 backdrop-blur-[2px] lg:backdrop-blur-xl 
