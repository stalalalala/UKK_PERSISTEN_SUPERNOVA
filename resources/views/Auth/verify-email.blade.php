...
<body class="font-po bg-blue-50 font-poppins min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-3xl shadow-xl w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl p-6 sm:p-8 lg:p-10 text-center relative">

        <div class="mb-5 sm:mb-6">
            <div class="mx-auto w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 flex items-center justify-center rounded-full bg-blue-100">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
