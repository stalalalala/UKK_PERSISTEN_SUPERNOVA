    ...
    <main class="max-w-[1440px] mx-auto py-10">
        ...
        <section class="px-4 md:px-10">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                @php
                    // Map warna HANYA UNTUK TAG BADGE
                    $warnaTag = [
                ...
                @foreach ($allKuis as $k)
                    ...
                    {{-- Border tetap biru (hover:border-blue-300) --}}
                    <div
                        ...
                        <div class="flex justify-between items-start mb-6">
                            <div class="space-y-1">
                                <h4 class="font-bold text-blue-900 text-lg">Kuis Fundamental - Set {{ $k->set_ke }}
                                </h4>

                                {{-- TAG BADGE WARNA DINAMIS --}}
                                <span
                                    class="{{ $temaTag['light'] }} {{ $temaTag['text'] }} text-[10px] font-bold px-3 py-1 rounded-full uppercase">
                                    {{ $subtes }}
                                </span>
                            </div>
                            <span
