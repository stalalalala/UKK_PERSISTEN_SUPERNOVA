...
<head>
    ...
    <title>Instruksi Pengerjaan Latihan | PERSISTEN</title>
            ...
            <main class="flex-1 flex ">
                <div class="bg-white border border-gray-100 w-full flex flex-col overflow-hidden md:max-h-[100vh]">
                    ...
                    <div
                        ...
                        <a href="{{ route('latihan.index') }}" class="w-full md:w-auto order-2 md:order-1">
                            <button
                        ...
                        <a href="{{ route('latihan.soal', $latihan->id) }}"
