...
<head>
    ...
    <style>
        ...
        .inner-frame {
            ...
            /* Garis Dalam Sedikit Lebih Tipis */
            height: 100%;
            border-radius: 12px;
            padding: 35px 50px;
            text-align: center;
                ...
                <table>
                    <tr>
                        ...
                        <td style="border-left: 1px solid rgba(255,255,255,0.3);">
                            ...
                            <span
                                class="num-big">{{ $categories->count() > 0 ? number_format($skor_total / $categories->count(), 1) : 0 }}</span>
                        </td>
                    </tr>
                </table>
            </div>
