...
<head>
    ...
    <title>Instruksi Pengerjaan Tryout | PERSISTEN</title>
        ...
        <main class="flex-1 flex items-center justify-center p-4 md:p-10">
            <div
                ...
                <div class="flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
                    ...
                    <div
                        class="w-full md:w-[42%] bg-slate-50 p-6 md:p-8 flex flex-col items-center justify-start border-b md:border-b-0 md:border-r border-gray-100 overflow-y-auto custom-scroll">
                        ...
                        <div class="w-full space-y-6">
                            <div class="align-top md:text-left mb-8">
                                ...
                                <p class="text-xs text-gray-400 font-medium">Pastikan kamu siap sebelum memulai sesi
                                    ini.</p>
                            </div>
                    ...
                    <div class="w-full md:w-[58%] flex flex-col p-6 md:p-8 overflow-hidden bg-white">
                        ...
                        <div class="flex-1 overflow-y-auto custom-scroll pr-2 space-y-6">
                            <div class="flex items-start gap-5 instruction-card transition">
                                <div
                                    class="icon-number w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-md sm:rounded-2xl bg-[#FEA33A] shadow-lg shadow-orange-100 flex items-center justify-center text-white font-bold text-sm sm:text-xl transition duration-300">
                                    1
                                </div>
                                <div>
                            ...
                            <div class="flex items-start gap-5 instruction-card transition">
                                <div
                                    class="icon-number w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-md sm:rounded-2xl bg-[#9885FB] shadow-lg shadow-purple-100 flex items-center justify-center text-white font-bold text-sm sm:text-xl transition duration-300">
                                    2
                                </div>
                                <div>
                            ...
                            <div class="flex items-start gap-5 instruction-card transition">
                                <div
                                    class="icon-number w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-md sm:rounded-2xl bg-[#FF908E] shadow-lg shadow-red-100 flex items-center justify-center text-white font-bold text-sm sm:text-xl transition duration-300">
                                    3
                                </div>
                                <div>
                            ...
                            <div class="flex items-start gap-5 instruction-card transition">
                                <div
                                    class="icon-number w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-md sm:rounded-2xl bg-[#4B8A81] shadow-lg shadow-teal-100 flex items-center justify-center text-white font-bold text-sm sm:text-xl transition duration-300">
                                    4
                                </div>
                                <div>
                            ...
                            <div class="flex items-start gap-5 instruction-card transition">
                                <div
                                    class="icon-number w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-md sm:rounded-2xl bg-[#3171CD] shadow-lg shadow-blue-100 flex items-center justify-center text-white font-bold text-sm sm:text-xl transition duration-300">
                                    5
                                </div>
                                <div>
                ...
                <div
                    class="px-6 md:px-12 py-5 bg-slate-50 border-t border-gray-100 flex flex-col md:flex-row justify-end gap-3 md:gap-4 shrink-0">
                    <a href="{{ route('tryout.index') }}" class="w-full md:w-auto order-2 md:order-1">
                        <button
                            class="w-full px-10 py-2.5 rounded-xl font-semibold text-gray-500 bg-white border border-gray-200 hover:bg-gray-100 transition duration-300">
                            Kembali
                        </button>
                    </a>
                    @if ($firstCategory)
                        <a href="{{ route('tryout.soal', [$tryout->id, $firstCategory->id]) }}"
                            ...
                            <button
                                class="w-full px-12 py-2.5 rounded-xl font-semibold text-white bg-blue-500 hover:bg-blue-600 shadow-xl shadow-blue-200 transition duration-300 flex items-center justify-center gap-2">
