            ...
            <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="relative">
                    ...
                    <div x-show="openUniv" @click.away="openUniv = false" x-cloak
                        ...
                        <div class="p-2 border-b mb-2">
                            <input type="text" placeholder="Cari Univ..."
                                class="w-full p-2 text-sm bg-slate-50 rounded-lg outline-none border-none focus:ring-1 focus:ring-blue-400">
                        </div>
                        <div @click="univSelected = 'Universitas Indonesia'; openUniv = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Universitas Indonesia</div>
                        <div @click="univSelected = 'Institut Teknologi Bandung'; openUniv = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Institut Teknologi Bandung</div>
                        <div @click="univSelected = 'Universitas Gadjah Mada'; openUniv = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Universitas Gadjah Mada</div>
                        <div @click="univSelected = 'Universitas Airlangga'; openUniv = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Universitas Airlangga</div>
                        <div @click="univSelected = 'Universitas Padjadjaran'; openUniv = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Universitas Padjadjaran</div>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div x-show="openJurusan" @click.away="openJurusan = false" x-cloak
                        ...
                        <div @click="jurusanSelected = 'Teknik Informatika'; openJurusan = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Teknik Informatika</div>
                        <div @click="jurusanSelected = 'Sistem Informasi'; openJurusan = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Sistem Informasi</div>
                        <div @click="jurusanSelected = 'Ilmu Komunikasi'; openJurusan = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Ilmu Komunikasi</div>
                        <div @click="jurusanSelected = 'Kedokteran'; openJurusan = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Kedokteran</div>
                        <div @click="jurusanSelected = 'Psikologi'; openJurusan = false"
                            class="p-3 hover:bg-blue-50 rounded-xl cursor-pointer text-sm font-medium text-slate-700">
                            Psikologi</div>
                    </div>
                </div>
