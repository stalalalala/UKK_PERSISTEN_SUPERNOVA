...
<head>
    ...
    <title>Manajemen Karakter Streak - Admin | PERSISTEN</title>
                                        ...
                                        <td class="px-10 py-8 text-center">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                "
                                                    ...
                                                    <form action="{{ route('admin.streak.delete', $streak->id) }}"
                                ...
                                @forelse ($trash as $streak)
                                    <tr class="hover:bg-gray-50 transition-all">
                                        ...
                                        <td class="px-8 py-12 text-center flex gap-2 justify-center">
                                            ...
                                            <form action="{{ route('admin.streak.forceDelete', $streak->id) }}"
                                                method="POST" class="hidden">
                                                @csrf
                                                @method('DELETE')
                                            </form>
