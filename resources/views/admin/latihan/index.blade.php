...
<head>
    ...
    <title>Manajemen Latihan Soal - Admin | PERSISTEN</title>
...
<body class="bg-[#E9EFFF] h-screen flex overflow-hidden text-[#2D3B61]" x-data="{
    ...
    <main class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        <header
            class="flex flex-col lg:flex-row lg:items-center justify-between p-4 lg:px-8 lg:pt-8 gap-4 flex-shrink-0 w-full">
