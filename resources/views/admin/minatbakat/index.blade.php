...
<body class="bg-[#E9EFFF] h-screen overflow-hidden text-[#2D3B61]" x-data="{
    ...
    exportData() {
        window.location.href = '{{ route('admin.minatbBkat.export') }}';
    },
    ...
    <div class="flex h-full w-full">
        <aside :class="mobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
            ...
            <nav
                ...
                <<<<<<< HEAD <a href="{{ route('admin.dashboard.index') }}"
                    class="w-full flex items-center gap-4 px-4 py-3 rounded-2xl transition-all duration-200 group text-left">
                    ...
                    <a href="{{ route('admin.laporan.index') }}"
                        ...
                        <form action="{{ route('logout') }}" method="POST" class="w-full inline">
                            ...
                            <button type="submit"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor" class="size-5 md:size-6 text-white">
                                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="#" x-init="if (currentPage === 'minat_bakat') { $el.scrollIntoView({ block: 'center' }) }"
    ...
    <div x-show="showModal" x-cloak class="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <div class="bg-white rounded-[28px] w-full max-w-md p-8 relative shadow-2xl"
            ...
            <div class="space-y-5">
                <div>
                    <label class="text-[10px] font-bold text-gray-400 uppercase block mb-2 tracking-widest">Nama
                        Kategori</label>
                ...
                <div>
                    <label class="text-[10px] font-bold text-gray-400 uppercase block mb-2 tracking-widest">Deskripsi
                        Minat Bakat</label>
                ...
                <div>
                    <label class="text-[10px] font-bold text-gray-400 uppercase block mb-2 tracking-widest">Warna
                        Identitas</label>
