...
<body class="bg-[#F8FAFC]" x-data="monitoringApp()">
                    ...
                    <div x-data="{ open: false }" class="relative flex-1 lg:flex-initial">
                        <div @click="open = !open"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="2.5" stroke="currentColor" class="w-3.5 h-3.5 text-gray-500">
    ...
    <div x-show="showDraftDetail" x-transition x-cloak
        ...
        <div @click.away="showDraftDetail = false"
            class="bg-white rounded-[2rem] w-full max-w-2xl overflow-hidden shadow-2xl">
            <div class="bg-slate-900 p-8 text-white flex justify-between items-center">
                <h4 class="text-xl font-black uppercase" x-text="selectedDraftTitle"></h4>
                <button @click="showDraftDetail = false" class="text-slate-500 hover:text-white"><svg class="w-8 h-8"
