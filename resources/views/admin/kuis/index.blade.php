...
<body class="bg-[#E9EFFF] h-screen flex overflow-hidden text-[#2D3B61]" x-data="{
    ...
    <div class="flex items-center justify-between lg:justify-end w-full lg:w-auto gap-4 lg:order-2">
        ...
        <div x-data="{ open: false }" class="relative flex-1 lg:flex-initial">
            <div @click="open = !open" 
                class="flex items-center justify-between lg:justify-start gap-3 bg-white p-1 pr-4 pl-1 rounded-full shadow-sm cursor-pointer border border-transparent hover:border-blue-100 transition-all w-full">
...
<form action="{{ route('admin.kuis.destroy', $item->id) }}" method="POST" class="hidden">
    @csrf
    @method('DELETE')
</form>
                    ...
                    <form action="{{ route('admin.kuis.restore', $trashItem->id) }}" method="POST" class="hidden">
                        @csrf
                    </form>
            ...
            <form action="{{ route('admin.kuis.forceDelete', $trashItem->id) }}" method="POST" class="hidden">
                @csrf
                @method('DELETE')
            </form>
