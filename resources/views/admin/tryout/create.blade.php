...
<body class="bg-[#E9EFFF] h-screen overflow-hidden text-[#2D3B61]" x-data="{
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-wrap gap-2 w-full md:w-auto">
                                <button type="button" @click="showImportModal = true"
                                    class="w-full md:w-auto bg-white border border-blue-100 text-[#4A72D4] px-6 py-3 rounded-2xl font-bold text-xs shadow-lg flex items-center justify-center gap-2 hover:scale-105 transition-all">
                        ...
                        <div
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Nama
                                    Tryout *</label>
                                <input type="text" x-model="namaTryout" @input="saveLocal()"
                                    @input="isDirty = true" required
                            ...
                            <div class="space-y-2">
                                <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Mulai
                                    *</label>
                                <input type="date" x-model="tglMulai" @input="saveLocal()"
                                    @input="isDirty = true" required
                                    class="w-full bg-gray-50 rounded-2xl py-4 px-6 text-sm outline-none">
                            </div>
                            <div class="space-y-2">
                                <label
                                    class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Selesai
                                    *</label>
                                <input type="date" x-model="tglSelesai" @input="saveLocal()"
                                    @input="isDirty = true" required
                                    class="w-full bg-gray-50 rounded-2xl py-4 px-6 text-sm outline-none">
                            </div>
                        </div>
                                ...
                                <div @click="selectSubtes(index)"
                                    ...
                                    <div class="flex justify-between items-start mb-4">
                                        <div class="p-3 rounded-2xl"
                                            :class="sub.completed ? 'bg-emerald-100 text-emerald-600' :
                                                'bg-blue-50 text-[#4A72D4]'">
                                            <i class="fa-solid"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-6">
                                <div
                                    ...
                                    <h4 class="text-[10px] font-bold text-gray-400 uppercase mb-6 tracking-widest">
                                        Navigasi
                                        Soal</h4>
    ...
    <div x-show="showSuccessModal" x-cloak class="fixed inset-0 z-[160] flex items-center justify-center p-4">
        ...
        <div class="bg-white rounded-[2rem] p-8 max-w-sm w-full relative z-[161] text-center shadow-2xl border border-blue-50"
            ...
            <button type="button" @click="showSuccessModal = false" {{-- MODAL KEMBALI --}} <div
                x-show="showConfirmBackModal" x-cloak
                ...
                <div
                    ...
                    <p class="text-gray-500 text-sm mb-8">Data belum disimpan. Jika keluar sekarang, data akan dihapus.
                    </p>
