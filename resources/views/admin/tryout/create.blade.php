    ...
    <div class="flex h-full w-full">
        ...
        <main class="flex-1 flex flex-col min-w-0 h-full overflow-y-auto custom-scrollbar p-4 lg:p-8">
            ...
            <div x-show="activeSubtesIndex === null" x-transition>
                <div class="mb-8">
                    <h2 class="text-2xl font-extrabold text-[#4A72D4]">Panel Tryout Nasional</h2>
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-xs font-medium uppercase tracking-widest">Pengisian Soal
                                Tryout
                            </p>
                        </div>
                    </div>
