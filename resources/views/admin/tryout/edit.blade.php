...
<body class="bg-[#E9EFFF] h-screen overflow-hidden text-[#2D3B61]" x-data="editTryoutForm()">
    ...
    <div class="flex h-full w-full">
        <aside class="fixed inset-y-0 left-0 z-50 w-72 bg-[#4A72D4] text-white flex flex-col p-6 shadow-xl lg:static shrink-0 h-full">
            ...
            <nav class="flex-1 space-y-1">
                <a href="{{ route('admin.tryout.index') }}" class="w-full flex items-center gap-4 px-4 py-3 rounded-2xl bg-[#D4DEF7] text-[#2E3B66]">
                    <i class="fa-solid fa-file-pen"></i><span class="font-bold text-sm">Edit Tryout</span>
                </a>
            </nav>
        </aside>
