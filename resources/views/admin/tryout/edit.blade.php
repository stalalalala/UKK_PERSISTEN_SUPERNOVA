...
laporan</span>
    ...
    <button type="submit" class="mt-4 w-full flex items-center bg-white/10 hover:bg-white/20 px-6 py-3 rounded-2xl transition-all group border border-white/20 backdrop-blur-sm shrink-0">
        ...
        <main class="flex-1 flex flex-col h-full overflow-y-auto custom-scrollbar p-4 lg:p-8">
             <header class="flex flex-col lg:flex-row lg:items-center justify-between lg:pt-2 pb-8 gap-4 flex-shrink-0 w-full">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2 space-y-6">
                            <div class="bg-white rounded-[30px] p-8 shadow-sm border border-blue-50">
                                ...
                                <div class="flex items-center justify-between mt-10">
                                    ...
                                    <button type="button" @click="simpanSoal()" class="bg-[#4A72D4] text-white px-10 py-4 rounded-2xl font-bold text-sm shadow-lg hover:-translate-y-1 transition-all">SIMPAN SOAL</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-white p-6 rounded-[30px] shadow-sm border border-blue-50 text-center sticky top-8">
                                ...
                                <button type="button" @click="activeSubtesIndex = null" class="w-full py-4 bg-emerald-500 text-white rounded-2xl font-black text-[10px] uppercase shadow-lg">Selesai Kelola</button>
                            </div>
                        </div>
                    </div>
                </div>
