...
<body class="bg-[#E9EFFF] h-screen flex overflow-hidden text-[#2D3B61]" x-data="{
    ...
    <form id="delete-form-{{ $t->id }}" action="{{ route('admin.tryout.destroy', $t->id) }}" method="POST" class="hidden">
        ...
        @foreach ($tryouts as $t)
            <form id="delete-form-{{ $t->id }}" action="{{ route('admin.tryout.destroy', $t->id) }}"
    ...
    <div x-show="mobileMenuOpen" x-transition x-cloak @click="mobileMenuOpen = false"
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-blue-50 flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"
                            x-text="allTryout.filter(t => t.is_active).length"></h4>
                    </div>
                </div>
                <div
                                ...
                                <tr class="hover:bg-orange-50/30 transition-colors group">
                                    ...
                                    <td class="px-8 py-5 text-center">
                                        <span
                                            ...
                                            x-text="hist.is_active ? 'Aktif' : 'Nonaktif'"></span>
                                    </td>
                                    <td class="px-8 py-5 text-center">
